                            ...
                            <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left input_mask">
                                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                        <input type="text" class="form-control" id="deviceModelProperty" name="deviceModelProperty" placeholder="deviceModelProperty">
                                        <span class="fa fa-phone form-control-feedback left" aria-hidden="true"></span>

                                    </div>

                                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                        <input type="text" class="form-control" id="device" name="device" placeholder=" دستگاه ">
                                        <span class="fa fa-phone form-control-feedback left" aria-hidden="true"></span>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                        <input type="text" class="form-control" id="cover" name="cover" placeholder="کاور">
                                        <span class="fa fa-phone form-control-feedback left" aria-hidden="true"></span>
                                    </div>
